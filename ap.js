...
global.ownerName = 'YudzzXD'//ubah nama lu
global.botName = 'WhatsApp'//ubah nama bot lu
global.author = 'YudzzXD'//ubah keinginan mu
global.packname = '🗿'//ubah keinginan mau
global.ownerNumber = ["6285840104297@s.whatsapp.net"]//ubah nomer lu
global.prefa = ['','.']
global.yt = 'http://wahyudiid.w3spaces.com'//ubah nama yt lu
global.mess = {
wait: 'SABAR OM....',
succes: 'SUKSES✓',
...
{title: " KIRIM BUG", rowId: prefix+"transfer", description: "1 Nomer,Rp.1.000"}]},

{title: "SCRIPT BOT",
rows: [
{title: "SC STORE", rowId: prefix+"tdhdhfbb", description: "Sc Store Cocok buat jualan Rp.15.000"},
{title: "SC BUG", rowId: prefix+"trjdufujuf", description: "Sc Bug No Pasaran Rp.20.000"},
{title: "SC BUG + Store", rowId: prefix+"trjrududh", description: "Sc Bug No Pasaran Rp.25.000"}]},
{title: "NOKOS",
rows: [
{title: "Nokos Nya", rowId: prefix+"njfjfjjfj", description: "klik untuk memilih nokos yg tersedia"}]},
],
footer: footer_nya,
mentions:[global.author, sender]})
}
...
break
case 'yuds':{
return ardian.reply(`╔═══════✪ WebSite Pemilik 
╠  Berikut Adalah Website Saya
╠ ❐ : https://wahyudiid.w3spaces.com
╚═════════════✪`)
}
break
case 'ig':{
...
╠ ❐ : https://instagram.com/lebihkerendariandy_warholl.id
...
break
case 'bot':{
return ardian.reply(`Apaa Njing!!`)
}
break
case 'C':{
return ardian.reply(`inisial pacar owner, Chindy`)
}
break
case 'p':{
return ardian.reply(`salam tolol`)
}
break
case 'stickermaker':{
...
{title: " ❤️ Ovo", rowId: prefix+"ovo", description: " "},
...
case'play': case 'ytplay': {
                if (!text) throw `contoh : ${prefix + command} Wish You Were Here`
